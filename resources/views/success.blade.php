...
<body class="bg-black flex flex-col justify-center items-center min-h-[100vh]">
    ...
    <section class="mb-10 pt-24 py-24 bg-black min-h-[85vh]">
        ...
        <div class="mx-5 pt-24 lg:mx-52 flex justify-center items-center flex-col">
            <img class="w-24 mb-12" src="/img/party.webp" alt="Alegre">
            ...
            <a class="text-lg font-inter font-semibold text-white px-10 py-3 bg-green-600 hover:bg-green-800 rounded-3xl" href="{{$link}}">Volver</a>
        </div>
